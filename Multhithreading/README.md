...
| 4 | [Locks](./Part4-Locks.md) | synchronized vs ReentrantLock, situational lock-selection guide, ReadWriteLock, StampedLock, optimistic vs pessimistic locking, deadlock/livelock/starvation, Dining Philosophers |
...
| 6 | [Concurrent Collections](./Part6-Concurrent-Collections.md) | ConcurrentHashMap internals, CopyOnWriteArrayList, BlockingQueue variants, ThreadLocal, ThreadLocalRandom, LRU cache design |
| 7 | [Fork/Join & Parallelism](./Part7-ForkJoin-Parallelism.md) | Concurrency vs parallelism, ForkJoinPool, RecursiveTask, work-stealing, custom thread pool for parallel streams |
